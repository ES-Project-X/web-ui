                                ...
                                <div className="flex flex-col w-full">
                                    <div className="grid h-15 bg-transparent bg-base-300 place-items-center relative pt-3">
                                        <div className="flex items-center">
                                            ...
                                            <span className="ml-1">Total Added POIs: {added_pois_count}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid h-15 bg-transparent bg-base-300 place-items-center relative">
                                        <div className="flex items-center">
                                            ...
                                            <span className="ml-1">Total Received Ratings: {received_ratings_count}</span>
                                        </div>
                                    </div>
                                    <div className="divider"></div>
                                    <div className="grid h-15 bg-transparent bg-base-300 place-items-center relative">
                                        <div className="flex items-center">
                                            ...
                                            <span className="ml-1">Total Given Ratings: {given_ratings_count}</span>
                                        </div>
                                    </div>
                                </div>
                            </details>
